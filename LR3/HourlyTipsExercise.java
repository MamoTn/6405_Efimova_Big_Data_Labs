...
public class HourlyTipsExercise extends ExerciseBase {
	...
	public static void main(String[] args) throws Exception {
		...
		DataStream<Tuple3<Long, Long, Float>> hourlyTips = fares
				.keyBy(fare -> fare.driverId) // Группируем по водителю
				.window(TumblingEventTimeWindows.of(Time.hours(1))) // Создаем часовое окно
				.process(new AddTips()); // Вызываем наш класс для суммирования

// Из всех результатов максимальный
	...
	public static class AddTips extends ProcessWindowFunction<
			...
			Tuple3<Long, Long, Float>, // Тип выходных данных (Конец окна, ID водителя, Сумма)
